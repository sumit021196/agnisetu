...
const PersonCard = ({ name, role, location, bio }) => (
  <motion.div 
    whileHover={{ y: -5 }}
...
const ServiceCard = ({ title, price, duration, rating }) => (
  <motion.div 
    whileHover={{ x: 5 }}
  ...
  >
    ...
    <div className="text-right">
      ...
      <p className="text-[10px] text-text-secondary">Book Now</p>
    </div>
  </motion.div>
);
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="md:col-span-2 space-y-6">
                <div className="flex justify-between items-center">
                  ...
                  <button className="text-primary-saffron text-sm font-semibold flex items-center gap-1 hover:underline">View All <ChevronRight size={16}/></button>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <JobCard title="Software Architect" company="Saraswati Tech" location="Pune, India" type="Full-time" salary="₹25L - 35L" />
                  <JobCard title="Strategic Consultant" company="Veda Analytics" location="Bangalore" type="Remote" salary="₹18L - 24L" />
                </div>
              </div>
              
              <div className="space-y-6">
                <h2 className="text-2xl font-bold">Dharma Services</h2>
                <div className="space-y-4">
                  <ServiceCard title="Satyanarayan Pooja" price="5100" duration="4 Hours" rating="4.9" />
                  <ServiceCard title="Grah Shanti Anushthan" price="21000" duration="2 Days" rating="5.0" />
                  <ServiceCard title="Vedic Wedding Rituals" price="51000" duration="Full Event" rating="4.8" />
                </div>
              </div>
            </div>
          </div>
        ...
        return (
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
               ...
               <JobCard title="Digital Marketing Lead" company="Bharat Media" location="Delhi" type="Full-time" salary="₹12L - 15L" />
               <JobCard title="Chartered Accountant" company="Vyas & Sons" location="Ahmedabad" type="Full-time" salary="₹20L+" />
               <JobCard title="Vedic Teacher" company="Gurukul International" location="Hrishikesh" type="Part-time" salary="₹40k/mo" />
               <JobCard title="Social Media Manager" company="Dharma Foundation" location="Remote" type="Freelance" salary="₹25k/task" />
               <JobCard title="App Developer" company="Setu Tech" location="Hyderabad" type="Full-time" salary="₹15L - 25L" />
            </div>
          </div>
        );
      case 'Connect':
        return (
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
               <PersonCard name="Arjun Sharma" role="Software Engineer" location="Bangalore" bio="Passionate about AI and Vedic Mathematics. Looking to mentor young talent." />
               <PersonCard name="Pandit Ravi Vyas" role="Vedic Scholar" location="Varanasi" bio="Expert in Shukla Yajurveda and Astrological guidance." />
               <PersonCard name="Priya Mishra" role="Entrepreneur" location="Delhi" bio="Founder of 'Sanskriti Foods'. Empowering women through home industries." />
               <PersonCard name="Rohan Chaturvedi" role="Civil Service" location="LBSNAA" bio="Focused on social reform and community upliftment through education." />
               <PersonCard name="Deepak Pandey" role="Marketing Head" location="Mumbai" bio="Helping Brahman businesses scale through digital strategies." />
               <PersonCard name="Amit Tiwari" role="Doctor" location="Lucknow" bio="Specializing in Ayurveda and Modern Medicine integration." />
            </div>
          </div>
        );
      case 'Dharma':
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="glass p-8 rounded-3xl space-y-6">
                <h2 className="text-2xl font-bold flex items-center gap-2"><Flame className="text-accent-red" /> Ritual Bookings</h2>
                <div className="space-y-4">
                  <ServiceCard title="Sanskrit Classes" price="1200/mo" duration="Weekly" rating="4.9" />
                  <ServiceCard title="Vedic Marriage Rituals" price="51001" duration="Full Event" rating="5.0" />
                  <ServiceCard title="Astrology Consultation" price="1100" duration="1 Hour" rating="4.7" />
                  <ServiceCard title="Vastu Shastra Consultation" price="5000" duration="Site Visit" rating="4.9" />
                </div>
              </div>
              <div className="glass p-8 rounded-3xl space-y-6">
                <h2 className="text-2xl font-bold flex items-center gap-2"><Star className="text-secondary-gold" /> Upcoming Events</h2>
                <div className="space-y-4">
      ...
      case 'Matrimony':
        return (
          <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6 text-center">
            ...
            <div>
              <h1 className="text-4xl font-black">Matrimonial Portal</h1>
              <p className="text-text-secondary mt-2 max-w-md">Our high-quality Matchmaking module is launching in Q3 2026. Stay tuned to find your life partner within the community.</p>
            </div>
            <button className="px-8 py-4 bg-white/5 border border-primary-saffron/30 text-primary-saffron font-bold rounded-2xl hover:bg-primary-saffron/10 transition-all">Get Notified</button>
          </div>
        );
    }
  };
    ...
    <div className="min-h-screen bg-bg-deep flex">
      ...
      <aside className="w-64 bg-bg-sidebar hidden md:flex flex-col border-r border-glass-border fixed h-full z-50">
        ...
        <nav className="flex-1 mt-4">
          ...
          <SidebarItem icon={Briefcase} label="Careers" active={activeTab === 'Careers'} onClick={() => setActiveTab('Careers')} />
          <SidebarItem icon={Users} label="Connect" active={activeTab === 'Connect'} onClick={() => setActiveTab('Connect')} />
          <SidebarItem icon={Flame} label="Dharma" active={activeTab === 'Dharma'} onClick={() => setActiveTab('Dharma')} />
          <SidebarItem icon={BookOpen} label="Gyan" active={activeTab === 'Gyan'} onClick={() => setActiveTab('Gyan')} />
          <SidebarItem icon={Star} label="Matrimony" active={activeTab === 'Matrimony'} onClick={() => setActiveTab('Matrimony')} />
        </nav>

        <div className="p-6">
          <div className="glass p-4 rounded-xl text-xs space-y-3">
            <p className="font-bold text-primary-saffron uppercase">Social Unity</p>
            <p className="text-text-secondary leading-relaxed">Join 5,000+ members in our community upliftment journey.</p>
      ...
      <main className="flex-1 ml-0 md:ml-64 min-h-screen">
        ...
        <header className="h-20 glass sticky top-0 z-40 px-4 md:px-8 flex items-center justify-between border-b border-glass-border">
          ...
          <div className="hidden md:flex items-center gap-2 glass px-4 py-2 rounded-xl text-sm border-white/5">
            ...
            <input type="text" placeholder="Search for jobs, events..." className="bg-transparent border-none outline-none text-white w-64" />
          </div>
      ...
      <nav className="fixed bottom-0 left-0 right-0 h-20 glass z-50 flex items-center justify-around px-4 md:hidden border-t border-glass-border">
        {[
